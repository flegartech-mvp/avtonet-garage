...
## Routes / screens used
- `audit/screenshots/final-ready/AvtoNetGarage/02-dashboard-store.png`
- `audit/screenshots/final-ready/AvtoNetGarage/03-advisor-store.png`
- `audit/screenshots/final-ready/AvtoNetGarage/04-detail-store.png`
...
- `videos/01-instagram-reel.mp4` (5.8 MB)
- `videos/02-tiktok.mp4` (5.8 MB)
- `videos/03-youtube-short.mp4` (5.8 MB)
- `videos/04-linkedin-demo.mp4` (9.5 MB)
- `videos/05-x-demo.mp4` (6.6 MB)
- `videos/06-facebook-demo.mp4` (9.4 MB)
- `videos/07-github-readme-demo.mp4` (4.5 MB)
- `videos/08-portfolio-hero.mp4` (9.4 MB)
- `videos/gifs/github-readme-demo.gif` (5.6 MB)
- `videos/gifs/short-demo.gif` (7.5 MB)
...
**Screens/routes used:** Garage dashboard, Smart Advisor, Listing detail.
