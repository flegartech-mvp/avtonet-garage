# AvtoNetGarage — Promo Pack

**Tagline:** Your avto.net garage, organized.

Save listings, track price changes hourly, and get a risk score per vehicle.
...
**Instagram**
> AvtoNetGarage 🚗 — turn avto.net into a proper garage. Save listings, track price drops hourly, and get a Smart Advisor risk score on every vehicle.

**LinkedIn**
> AvtoNetGarage — a Chrome extension that organizes your avto.net car search. Save listings into folders, track price changes hourly with alerts, and read a Smart Advisor risk score per vehicle.

**X / Twitter**
> AvtoNetGarage — your avto.net garage, organized. Save listings, hourly price tracking, per-car risk score.

**Facebook**
> AvtoNetGarage organizes your avto.net car hunt — saved listings, hourly price alerts and risk scores.

**GitHub (repo description / social preview alt)**
> AvtoNetGarage — MV3 extension (React/TS) for tracking avto.net listings, prices & risk scores.

## Source screenshots

- `AvtoNetGarage-main/promo/source-screenshots/01-shot-02-dashboard-store.png` (from `audit/screenshots/final-ready/AvtoNetGarage/02-dashboard-store.png`)
- `AvtoNetGarage-main/promo/source-screenshots/02-shot-03-advisor-store.png` (from `audit/screenshots/final-ready/AvtoNetGarage/03-advisor-store.png`)
- `AvtoNetGarage-main/promo/source-screenshots/03-shot-04-detail-store.png` (from `audit/screenshots/final-ready/AvtoNetGarage/04-detail-store.png`)
...
**Structure:** title card → main UI reveal → 3 feature callouts → second screen → CTA card (“Built by FlegarTech · Demo-ready product · github.com/flegartech/AvtoNetGarage”).
**Audio:** none (silent by default). Add royalty-free music in an editor if desired.

**Suggested video caption (Reels / TikTok / Shorts):**
> AvtoNetGarage in motion 🚗 — saved listings, hourly price tracking and a risk score per car.

To rebuild: `node build-videos.mjs AvtoNetGarage-main` (or `promo/scripts/build-video.sh`).
